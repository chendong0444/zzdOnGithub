...
function (a) {
    ...
    e.click = e.mousedown = e.mouseup = e.mousemove = "MouseEvents", a.event = {
        ...
        return this.each(function () {
            n(this, a, b, null, null, c)
        })
    }, a.fn.unbind = function (a, b) {
        return this.each(function () {
            o(this, a, b)
        })
    }, a.fn.one = function (a, b, c) {
        return this.each(function (d, e) {
            n(this, a, b, null, function (a, b) {
                return function () {
                    var c = a.apply(e, arguments);
                    return o(e, b, a), c
                }
            }, c)
        })
    ...
    }, a.fn.on = function (b, c, d, e) {
        return !c || a.isFunction(c) ? this.bind(b, c || d, e) : this.delegate(c, b, d)
...
function (a, b) {
    ...
    a.fn.show = function (a, c) {
        ...
        return c > 0 ? this.css("opacity", 0) : c = 1, e.call(this)
            .fadeTo(a, c, b)
        ...
        .ready(function () {
            ...
            a(document.body)
                .bind("touchstart", function (d) {
                    m = Date.now(), n = m - (b.last || m), b.el = a(h(d.touches[0].target)), c && clearTimeout(c), b.x1 = d.touches[0].pageX, b.y1 = d.touches[0].pageY, n > 0 && n <= 250 && (d.preventDefault(), b.isDoubleTap = !0), b.last = m, g = setTimeout(j, f)
                })
                ...
                .bind("touchend", function (f) {
                    k(), b.x2 && Math.abs(b.x1 - b.x2) > 30 || b.y2 && Math.abs(b.y1 - b.y2) > 30 ? e = setTimeout(function () {
                        ...
                        var d = a.Event("tap");
                        d.cancelTouch = l, b.el.trigger(d), d.defaultPrevented && (o = !0), b.isDoubleTap ? (b.el.trigger("doubleTap"), b = {}) : c = setTimeout(function () {
