...
PurchaseAppConfig.Domain = 'http://cart.jd.com/cart';
...
function mediavCount(pid) {
	try{
		...
		if(pid == null) {
			var items = document.getElementById('ids').value;
			if(items!=null&&items!=""){
