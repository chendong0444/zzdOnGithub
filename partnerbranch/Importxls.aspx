<%@ Page Language="C#" EnableViewState="false" AutoEventWireup="true" Inherits="AS.GroupOn.Controls.PartnerBranchPage" %>
...
protected void Page_Load(object sender, EventArgs e)
{
    ...
    //if (!b.GetrolePage(b.GetCookie("username"), Request.RawUrl))
    //{
    //    b.SetError("没有权限进行此操作");
    //    b.SetRefer();
    //    Response.Redirect(Utils.WebSiteHelper.GetReferUrl());
    //    Response.End();
    //    return;
    //}
...
<table width="600" border="0" align="center" bgcolor="#CCCCCC" cellpadding="10" cellspacing="1px">
  <tr>
    <td bgcolor="#FFFFFF"><div class="field"><label>选择文件：</label>  
  ...
  <input type="submit" name="button" id="button" value="提交" class="validator formbutton"/></div></td>
  </tr>
  <tr>
    <td bgcolor="#FFFFFF"><strong>注：请上传xls文档，暂不支持订单生成快递单号短信提醒。 </strong>
        <br />
        <br />
        ...
        <br />
        <br />
        <a href="<%=PageValue.WebRoot%>upfile/demo/demo.xls"><strong>点击此处下载范例文档</strong></a></td>
  </tr>
</table>
</td>
  </tr>
