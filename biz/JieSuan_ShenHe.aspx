                                ...
                                <div class="search">
                                   ...
                                   <ul class="filter">  
                                    ...
                                    <li class="" <%=Utility.GetStyle("JieSuan.aspx") %>>
                                      <a href="JieSuan.aspx?Id=<%=partnerId%>">结算信息</a><span></span>
                                    </li>
                                    <li  class="current" <%=Utility.GetStyle("JieSuan_ShenHe.aspx") %>>
                                     <a href="JieSuan_ShenHe.aspx?Id=<%=partnerId%>">结算详情</a><span></span>
                                    </li>
                                    <li class="" <%=Utility.GetStyle("ShangHu.aspx") %>>
                                     <a href="Zi_ShangHu.aspx">返回</a><span></span>
                                     </li>
...
--%>                                                        <a class='ajaxlink' href='<%=AS.GroupOn.Controls.PageValue.WebRoot %>manage/ajax_manage.aspx?action=partner_detailstate&Id=<%=item.id %>&state=<%=item.settlementstate %>&num=<%=item.num %>&teamid=<%=item.team_id%>&pid=<%=item.partnerid %>'>审核</a>
<%--                                                         | <a class='ajaxlink' href='<%=AS.GroupOn.Controls.PageValue.WebRoot %>manage/ajax_manage.aspx?action=PartnerXiangQing&Id=<%=item.id %>'>详情</a>
--%>                                                    </td>
                                                </tr>
                                            <%}%>
                                            <tr>
