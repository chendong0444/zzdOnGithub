...
<script  runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        string keyy = AS.Common.Utils.FileUtils.GetKey();
        int idd = AS.Common.Utils.Helper.GetInt(AS.Common.Utils.CookieUtils.GetCookieValue("partner", keyy), 999999);  //如果没有取到商户id，设置999999，返回空集合
        filter.ParentId = idd;
        //for test
        //SetSuccess("key="+keyy+"partner =" + AS.Common.Utils.CookieUtils.GetCookieValue("partner", keyy));
