...
<script runat="server">
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (type == "chanpin")
        {
            this.chanpin.Attributes.Add("style", "display:block");
        }
        ...
        {
            this.jiesuan.Attributes.Add("style", "display:block");
        }
...
<li name="type"><a href="PartnerInfo.aspx?id=<%=id %>" target="Right">商家信息</a></li>
...
<dd><ul>
<li name="type"><a href="partner_index.aspx" target="Right">项目列表</a></li>
<li name="type"><a href="OrderList.aspx" target="Right">订单列表</a></li>
<li name="type"><a href="SHJieSuan.aspx" target="Right">商户结算</a></li>
...
<dd><ul>
<li name="type" ><a href="partner_index.aspx" target="Right" >项目列表</a></li>
<li name="type" ><a href="partner_XinjianXiangmu.aspx" target="Right" >新建项目</a></li>
</ul></dd>
</dl>
</div>
<div id="chanpin" runat="server" style=" display:none">
<dl class="acSide_Option">
<dt class="acSide_title">产品管理</dt>
<dd><ul>
<li name="type"><a href="ProductList.aspx" target="Right">产品列表</a></li>
<li name="type"><a href="ProductAdd.aspx" target="Right">新建产品</a></li>
</ul></dd>
</dl>
...
<li name="type"><a href="OrderList.aspx?key=4" target="Right">退款订单</a></li>
<li name="type"><a href="partner_ViewRefund.aspx" target="Right">退款审核</a></li>
</ul></dd>
</dl>
</div>
...
<dl class="acSide_Option">
<dt class="acSide_title">商户评论</dt>
<dd>
<ul>
<li name="type"><a href="Review.aspx?hid=0" target="Right">商户评论</a></li>
</ul>
</dd>
</dl>
...
<dl class="acSide_Option">
<dt class="acSide_title">商户资料</dt>
<dd><ul>
<li name="type"><a href="settings.aspx" target="Right">商户资料</a></li>
</ul></dd>
</dl>
</div>
<div id="jiesuan" runat="server" style=" display:none">
<dl class="acSide_Option" style="margin-top:0;">
...
<dl class="acSide_Option">
<dt class="acSide_title">本周统计</dt>
<dd><ul>
<li name="type"><a href="Tongji_Week_biz.aspx" target="Right">本周统计</a></li>
</ul></dd>
</dl>
</div>
<%--快递物流 --%>
...
<dl class="acSide_Option">
<dt class="acSide_title">分店管理</dt>
<dd><ul>
<li name="type"><a href="BranchList.aspx" target="Right">分店列表</a></li>
<li name="type"><a href="BranchAdd.aspx" target="Right">新建分店</a></li>
</ul></dd>
</dl>
</div>
