...
<script runat="server">
    ...
    {
        base.OnLoad(e);
        type = "pbranch";// Helper.GetString(Request["type"], String.Empty);
        Form.Action = "/pbranchLogin.aspx?type="+type;// GetUrl("后台管理", type != String.Empty ? "Login.aspx?type=" + type : "pbranchLogin.aspx");
...
<div id="login_bd">
	<div class="login_bd">
      <div class="login_hd">
        ...
        <div class="lgtit_mid">
        	<ul id="css">
            <li class="lg_lf <%if(type=="pbranch" || type==""){%>now_select<%} %> "><a href="<%=GetUrl("后台管理","Login.aspx?type=pbranch")%>">分站后台</a></li>
            	<li class="lg_lf <%if(type=="merchant"){%>now_select<%} %>" ><%--<a href="<%=GetUrl("后台管理","Login.aspx?type=merchant")%>">商家后台</a>--%></li>
