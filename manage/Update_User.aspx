                            ...
                            <div class="box-content">
                                ...
                                <div class="sect">
                                    ...
                                    <div class="field">
                                        <label>
                                            QQ号码</label>
                                        <input type="text" size="30" maxlength="30" name="Qq" id="qq" class="number" value="<%=users.Qq %>" />
                                    </div>
                                    ...
                                    <div class="field">
                                        ...
                                        <%if (users.Manager == "Y")
                                          {%>
                                        <input type="text" size="30" value="Y" name="Manager" class="number" maxlength="1"
                                            style="text-transform: uppercase;"
                                             />
                                        <% }
                                          else if (users.Manager == "N")
                                          {%>
                                        <input type="text" size="30" value="N" name="Manager" class="number" maxlength="1"
                                             style="text-transform: uppercase;" />
                                        <%}
                                            else
                                            {%>
