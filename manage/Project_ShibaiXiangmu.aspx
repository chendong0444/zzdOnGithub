...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        base.OnLoad(e);
        //判断管理员是否有此操作
        if (AdminPage.IsAdmin && AdminPage.CheckUserOptionAuth(PageValue.CurrentAdmin, ActionEnum.Option_Team_Failure))
        {
            SetError("你不具有查看失败项目列表的权限！");
        ...
        #endregion
        url = url + "&page={0}";
        url = "Project_ShibaiXiangmu.aspx?" + url.Substring(1);
        ...
        filter2.teamcata = 0;
        //filter2.State = TeamState.failure;
    ...
    public void AddTeam(int teamid)
    {
        ...
        Response.Redirect("Project_ShibaiXiangmu.aspx");
    }
    #endregion
                            ...
                            <div class="box-content">
                                <div class="head">
                                    ...
                                    <div class="search">
                                        ...
                                        <ul class="filter">
                                            <li class="<%=style %>"><a href="Project_ShibaiXiangmu.aspx">全部</a></li>
                                            <li class="<%=style1 %>"><a href="Project_ShibaiXiangmu.aspx?team_type=normal">团购</a></li>
                                            <li class="<%=style2 %>"><a href="Project_ShibaiXiangmu.aspx?team_type=seconds">秒杀</a></li>
                                            <li class="<%=style3 %>"><a href="Project_ShibaiXiangmu.aspx?team_type=goods">热销</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="sect">
                                        ...
                                        <tr>
                                            ...
                                            <tr class="alt">
                                                ...
                                                <td class="op">
                                                    ...
                                                    <a class="deal-title" href="Project_ShibaiXiangmu.aspx?remove=<%= teamInfo.Id%>"
                                                        ask="确定删除本项目吗?">删除</a>｜ <a class="deal-title" href="Project_ShibaiXiangmu.aspx?add=<%= teamInfo.Id %>"
                                                            ask="确定复制本项目吗？">复制</a>
                                                    <%
                                                    ...
                                                    <%}%>
                                                    <br />
                                                    <a href="Project_ShibaiXiangmu.aspx?downloadid=<%= teamInfo.Id %>">下载</a>
                                                    <%if (teamInfo.Delivery.ToString() == "express")
                                                      {%>
                                                    | <a href="Project_ShibaiXiangmu.aspx?addmall=<%=teamInfo.Id  %>&teamcata=1" ask="确定将本项目复制到商城吗?">
                                                        复制到商城</a>
                                                    <% }
