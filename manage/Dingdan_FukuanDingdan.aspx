...
<script runat="server">
    ...
    private void InitData()
    {
        ...
        sb1.Append("</tr>");
        url = url + "&page={0}";
        url = "Dingdan_FukuanDingdan.aspx?" + url.Substring(1);
        filter.State = "pay";
        filter.PageSize = 30;
                    ...
                    <div id="content" class="coupons-box clear mainwide">
                        <div class="box clear">
                            <div class="box-content">
                                <div class="head">
                                    <h2>
                                        付款订单</h2><form id="Form1" runat="server" method="get">
                                <div class="search">
                                            ...
                                            <%} %> />&nbsp;&nbsp; 完成订单时间：<input type="text" class="h-input" datatype="date" name="fromfinishtime"
                                                ...
                                                <%} %> />--<input type="text" class="h-input" datatype="date" name="endfinishtime"
                                                    ...
                                                    <%} %> />&nbsp;&nbsp; 筛选条件：<select id="select_type" name="select_type" class="h-input">
                                                        ...
                                                        <%} %> />&nbsp;&nbsp;
                                    <input type="submit" name="search"  onclick="return checkvale();" value="筛选" class="formbutton" style="padding: 1px 6px;
                                        width: 60px;" /></div>
                                </form>
                                </div>
