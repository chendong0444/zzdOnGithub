...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        base.OnLoad(e);
        //判断管理员是否有此操作
        if (AdminPage.IsAdmin && AdminPage.CheckUserOptionAuth(PageValue.CurrentAdmin, ActionEnum.Option_Order_Refund_Refunding))
        {
            SetError("你不具有查看退款订单列表的权限！");
    ...
    private void InitData()
    {
        ...
        sb1.Append("</tr>");
        url = url + "&page={0}";
        url = "Dingdan_TuikuanDingdan.aspx?" + url.Substring(1);
        filter.State = "refunding";
        filter.PageSize = 30;
                    ...
                    <div id="content" class="coupons-box clear mainwide">
                        <div class="box clear">
                            <div class="box-content">
                                <div class="head">
                                    <h2>
                                        退款订单</h2><form id="Form1" runat="server" method="get">
                                <div class="search">
