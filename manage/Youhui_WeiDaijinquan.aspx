...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        if (Request["download"] == "下载")
        {
            ...
            if (AdminPage.IsAdmin && AdminPage.CheckUserOptionAuth(PageValue.CurrentAdmin, ActionEnum.Option_Card_Down))
            {
                ...
                Response.Redirect("Youhui_WeiDaijinquan.aspx");
                Response.End();
                return;
            }
            else
    ...
    {
        url = url + "&page={0}";
        url = "Youhui_WeiDaijinquan.aspx?" + url.Substring(1);
        filter.consume = "N"; //未消费
        filter.FromEnd_time = DateTime.Now; //有效期结束时间
        filter.PageSize = 30;
    ...
    protected void BulkDel()
    {
        ...
        else
        {
            ...
            Response.Redirect("Youhui_WeiDaijinquan.aspx?page=" + Helper.GetInt(Request.QueryString["url"], 1));
        }
    }
                                ...
                                <div class="sect">
                                    <table id="orders-list" cellspacing="0" cellpadding="0" border="0" class="coupons-table">
                                        ...
                                        %>
                                            ...
                                            <td>
                                                <div style='word-wrap: break-word; overflow: hidden;'>
                                                    <a class="remove-record" href="Youhui_WeiDaijinquan.aspx?delId=<%=cardInfo.Id %>"  ask='确定要删除吗?'>删除</a>
                                                </div>
                                            </td>
                                        </tr>
                                        <%       
...
<script type="text/javascript">
    ...
    function GetDeleteItem(url) {
        ...
        if (str.length > 0) {
            ...
            if (istrue) {
                window.location = "Youhui_WeiDaijinquan.aspx?item=" + $("#items").val() + "&url=" + urls;
            }
        }
        else {
            alert("你还没有选择删除项！ ");
