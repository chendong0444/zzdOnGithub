...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        {
            if (AdminPage.IsAdmin && AdminPage.CheckUserOptionAuth(PageValue.CurrentAdmin, ActionEnum.Option_MallGuid_Add))
            {
                SetError("你不具有添加商城导航的权限！");
                        ...
                        <div class="box clear">
                            <div class="box-content">
                                            ...
                                            <tr>
                                                <td height="40px" width="">
                                                    <ul class="filter" style="width: 150px;">
                                                        ...
                                                        <li><a href="Shezhi_GuidList_mall.aspx">导航栏目显示</a></li>
                                                    </ul>
                                                </td>
                                            </tr>
                                        </tbody>
                                ...
                                <div class="sect">
                                    <%if (id > 0)
                                      {%>
                                    <input type="hidden" name="action" value="updateguid" />
                                    ...
                                    <%}
                                      ...
                                      {%>
                                    <input type="hidden" name="action" value="addguid" />
                                    <div class="wholetip clear">
                                    </div>
                                    <div class="field">
                                        <label>
                                    ...
                                    <div class="field">
                                        <label>
                                            排序：</label>
                                        <input type="text" class="number" value="0" group="g" datatype="number" size="30" name="guidsort" id="Text3" />
                                        <span class="inputtip"></span>
                                    </div>
                                    <div class="field">
                                        <label>
                                    ...
                                    <div class="field">
                                        ...
                                        <span class="inputtip"></span>
                                        <input type="hidden" name="teamormall" value="1" />
                                    </div>
                                    <% }%>
                                    <div class="act">
