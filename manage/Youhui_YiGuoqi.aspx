...
<script runat="server">
    ...
    private void InitData()
    {
        ...
        url = url + "&page={0}";
        url = "Youhui_YiGuoqi.aspx?" + url.Substring(1);
        filter.Consume = "N";
        filter.ToExpire_time = DateTime.Now;
        filter.PageSize = 30;
        ...
        if (list_coupon != null && list_coupon.Count > 0)
        {
            foreach (ICoupon coupon in list_coupon)
            {
                ...
                if (coupon.Consume == "N" && coupon.Expire_time >= DateTime.Now)
                {
                    ...
                    sb2.Append("<a href=Youhui_YiGuoqi.aspx?couponsecret=" + coupon.Secret + "&couponid=" + coupon.Id + "' class='' ask='确认消费吗？'>消费</a></td>");
                }
                else
                {
                    ...
                    <div id="content" class="coupons-box clear mainwide">
                        <div class="box clear">
                            <div class="box-content">
                                <div class="head">
                                    <h2>
                                        已过期优惠卷</h2><form id="Form" runat="server" method="get">
                                <div class="search">
                                    时间：
