...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        base.OnLoad(e);
        //判断管理员是否有此操作
        if (AdminPage.IsAdmin && AdminPage.CheckUserOptionAuth(PageValue.CurrentAdmin, ActionEnum.Option_Invite_ErrorOperation))
        {
            SetError("你不具有查看违规记录的权限！");
    ...
    private void WeiGuiRecord()
    {
        ...
        /*---------------获取违规记录---------begin-----------------------------------------*/
        url = url + "&page={0}";
        url = "Index-YaoqingWeiGui.aspx?" + url.Substring(1);
        filter.Pay = "C";//违规记录
        filter.PageSize = 30;
