...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        if (Request["download"] == "下载")
        {
            ...
            if (AdminPage.IsAdmin && AdminPage.CheckUserOptionAuth(PageValue.CurrentAdmin, ActionEnum.Option_Card_Down))
            {
                ...
                Response.Redirect("Youhui_PaiFaDaijinquan.aspx");
                Response.End();
                return;
            }
            else
    ...
    {
        url = url + "&page={0}";
        url = "Youhui_PaiFaDaijinquan.aspx?" + url.Substring(1);
        filter.Fromuser_id = 0; //已派发
        filter.PageSize = 30;
    ...
    protected void BulkDel()
    {
        ...
        else
        {
            ...
            Response.Redirect("Youhui_PaiFaDaijinquan.aspx?page=" + Helper.GetInt(Request.QueryString["url"], 1));
        }
    }
                        ...
                        <div class="box clear">
                            <div class="box-content">
                                <div class="head">
                                    <h2>
                                        已派发代金劵</h2>
                                        <div class="search"> <select name="ddlcard">
                                            ...
                                            <input type="text" size="30" name="txtcontent" id="txtcontent" class="f-input" group="goto" style="width: 120px;"
                                ...
                                <div class="sect">
                                    <table id="orders-list" cellspacing="0" cellpadding="0" border="0" class="coupons-table">
                                        ...
                                        %>
                                            ...
                                            <td>
                                                <div style='word-wrap: break-word; overflow: hidden;'>
                                                    <a class="remove-record" href="Youhui_PaiFaDaijinquan.aspx?delId=<%=cardInfo.Id %>"  ask='确定要删除吗?'>删除</a>
                                                </div>
                                            </td>
                                        </tr>
                                        <%       
...
<script type="text/javascript">
    ...
    function GetDeleteItem(url) {
        ...
        if (str.length > 0) {
            ...
            if (istrue) {
                window.location = "Youhui_PaiFaDaijinquan.aspx?item=" + $("#items").val() + "&url=" + urls;
            }
        }
        else {
            alert("你还没有选择删除项！ ");
