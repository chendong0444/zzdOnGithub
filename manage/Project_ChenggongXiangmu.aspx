...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        base.OnLoad(e);
        //判断管理员是否有此操作
        if (AdminPage.IsAdmin && AdminPage.CheckUserOptionAuth(PageValue.CurrentAdmin, ActionEnum.Option_Team_Succes))
        {
            SetError("你不具有查看成功项目列表的权限！");
        ...
        url = url + "&page={0}";
        url = "Project_ChenggongXiangmu.aspx?" + url.Substring(1);
    ...
    public void AddTeam(int teamid)
    {
        ...
        Response.Redirect("Project_ChenggongXiangmu.aspx");
    }
    #endregion
                        ...
                        <div class="box clear">
                            <div class="box-content">
                                <div class="head">
                                    ...
                                    <div class="search">
                                        &nbsp;&nbsp; 属性：
                                        <asp:DropDownList class="h-input" ID="ddlhost" runat="server">
                                            <asp:ListItem Value="0">请选择</asp:ListItem>
                                            <asp:ListItem Value="2">推荐</asp:ListItem>
                                            <asp:ListItem Value="1">新品</asp:ListItem>
                                        </asp:DropDownList>
                                        分类：
                                        <asp:DropDownList class="h-input" Style="width: 150px" ID="ddlparent" runat="server">
                                        </asp:DropDownList>
                                        ...
                                        <ul class="filter">
                                            <li class="<%=style %>"><a href="Project_ChenggongXiangmu.aspx">全部</a></li>
                                            <li class="<%=style1 %>"><a href="Project_ChenggongXiangmu.aspx?team_type=normal">团购</a></li>
                                            <li class="<%=style2 %>"><a href="Project_ChenggongXiangmu.aspx?team_type=seconds">秒杀</a></li>
                                            <li class="<%=style3 %>"><a href="Project_ChenggongXiangmu.aspx?team_type=goods">热销</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="sect">
                                    <table id="orders-list" cellspacing="0" cellpadding="0" border="0" class="coupons-table">
                                        ...
                                        <tr>
                                            ...
                                            <tr class="alt">
                                                ...
                                                <% }
                                                   else if (teamInfo.Team_type == "draw")
                                                   { %>
                                                <td>
                                                    [抽奖]<a href="<%= href %>" target="_blank" class="deal-title">
                                                        <%=teamInfo.Title%></a>
                                                </td>
                                                <%
                                                    }
                                                ...
                                                <td class="op">
                                                    ...
                                                    <a class="deal-title" href="Project_ChenggongXiangmu.aspx?remove=<%= teamInfo.Id%>"
                                                        ask="确定删除本项目吗?">删除</a>｜ <a class="deal-title" href="Project_ChenggongXiangmu.aspx?add=<%= teamInfo.Id %>"
                                                            ask="确定复制本项目吗？">复制</a>
                                                    <%
                                                    ...
                                                    <%}%>
                                                    <br />
                                                    <a href="Project_ChenggongXiangmu.aspx?downloadid=<%= teamInfo.Id %>">下载</a>
                                                    <%if (teamInfo.Delivery.ToString() == "express")
                                                      {%>
                                                    | <a href='Project_ChenggongXiangmu.aspx?addmall=<%=teamInfo.Id  %>&teamcata=1"  ask="确定将本项目复制到商城吗?"'>
                                                        复制到商城</a>
                                                    <% }
