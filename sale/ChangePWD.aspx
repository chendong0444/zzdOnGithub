                            ...
                            <div class="box-content">
                                ...
                                <div class="sect">
                                    <div class="field">
                                        <label>
                                            用户名</label>
                                        <input type="text" size="30" name="username" group="a" readonly require="true" datatype="require"
                                    ...
                                    <input type="text" size="30" name="telphone" style="display:none;" id="telphone" class="f-input" runat="server" />
                                    <div class="field password">
                                        <label>
                                            登录密码</label>
                                        <input type="text" size="30" name="password" id="password" class="f-input" runat="server" />
                                        <div class="hint">
                                            <asp:Literal ID="ltMessage" Text="如果不想修改密码，请保持空白" runat="server"></asp:Literal></div>
                                    </div>
                                    <div class="act">
