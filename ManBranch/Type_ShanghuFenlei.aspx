		...
		<div class="box clear">
            ...
            <div class="box-content">
                <div class="head">
                    <h2>商户分类</h2>
					<ul class="filter">
						<li><a class="ajaxlink" href='ajax_manage.aspx?action=categoryedits&zone=partner'>新建商户分类</a></li>
					</ul>

                     <div class="sect">
					    <table id="orders-list" cellspacing="0" style="margin-top:10px;" cellpadding="0" border="0" class="coupons-table">
                            <tr>
                                <th>ID</th>
                                <th>中文名称</th>
                                <th>英文名称</th>
                            ...
                            <% int i = 0;
                                foreach (ICategory  item in IlistCategory)
                                {
                                  ...
                                  <%} i++; %>
                                      ...
                                      <td>
                                        <a ask="确认删除吗？" href="Type_ShanghuFenlei.aspx?remove=<%=item.Id %>">删除</a>｜
                                        <a class='ajaxlink' href="ajax_manage.aspx?action=categoryedits&update=<%=item.Id %>">编辑</a>
                                      </td>
                                  </tr>  
                                <%} %>
                        </table>
