...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(Request.QueryString["where_type"]))
        {
            ...
            {
                filter.id = Helper.GetInt(Request.QueryString["type_name"], 0);
            }
    ...
    private void InitData()
    {
        ...
        foreach (IPcoupon pcoupon in list_pcoupon)
        {
            ...
            sb2.Append("<td>" + "ID:" + team.Id + "(<a class='deal-title' href='" + getTeamPageUrl(team.Id) + "' target='_blank'>" + team.Title + "</a>)</td>");
            if (user != null)
            {
