...
<script runat="server">
    ...
    {
        url = url + "&page={0}";
        url = "Youhui_WeipaifaDaijinquan.aspx?" + url.Substring(1);
        filter.user_id = 0; //未派发
        filter.PageSize = 30;
    ...
    protected void Del()
    {
            ...
            if (strid != "" && strid != null)
            {
                ...
                Response.Redirect("Youhui_WeipaifaDaijinquan.aspx");
                Response.End();
                return;
            }
    ...
    protected void BulkDel()
    {
            ...
            Response.Redirect("Youhui_WeipaifaDaijinquan.aspx?page=" + Helper.GetInt(Request.QueryString["url"], 1));
                                ...
                                <div class="sect">
                                    <table id="orders-list" cellspacing="0" cellpadding="0" border="0" class="coupons-table">
                                        ...
                                        %>
                                            ...
                                            <td>
                                                <div style='word-wrap: break-word; overflow: hidden;'>
                                                    <a class="remove-record" href="Youhui_WeipaifaDaijinquan.aspx?delId=<%=cardInfo.Id %>"  ask='确定要删除吗?'>删除</a>
                                                </div>
                                            </td>
                                        </tr>
                                        <%       
...
<script type="text/javascript">
    ...
    function GetDeleteItem(url) {
        ...
        if (str.length > 0) {
            ...
            if (istrue) {
                window.location = "Youhui_WeipaifaDaijinquan.aspx?item=" + $("#items").val() + "&url=" + urls;
            }
        }
        else {
            alert("你还没有选择删除项！ ");
