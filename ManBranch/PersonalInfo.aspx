...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        using (AS.GroupOn.DataAccess.IDataSession session = AS.GroupOn.App.Store.OpenSession(false))
        {
            if (users != null)
            {
                if (users.City_id != null && users.City_id != 0)
                {
                        ...
                        <div class="box clear">
                            <div class="box-content">
                                <div class="head">
                                    <h2>
                                        修改个人信息</h2>
                                    <b style="margin-left: 20px; font-size: 16px;">（<%if (true)
                                                                                      {%>
                                ...
                                <div class="sect">
                                    ...
                                    <div class="field">
                                        <label>
                                            管理城市</label>
                                        <input type="text" size="30" readonly="readonly" name="UCitys" id="UCitys"  class="f-input" value=" <%if (cacity!=null)
                  {%>
                      <%=cacity.Name %> 
                  <%}else{%>您已经越权，请离开！ <% }%>" />
                                    </div>
