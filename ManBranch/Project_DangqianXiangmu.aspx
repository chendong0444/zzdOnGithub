...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        if (Request["btnselect"] == "筛选" || Request.QueryString["teamhost"] != null || Request.QueryString["CataID"] != null || Request.QueryString["teamhost"] != null || Request.QueryString["teamID"] != null || Request.QueryString["TitleLike"] != null || Request.QueryString["cityidIn"] != null || Request.QueryString["Partner_id"] != null)
        {
            ...
            else if (ddlhost.SelectedValue == "2" || Request.QueryString["teamhost"] == "1")
            {
                filter.teamhost = 2;
                url = url + "&teamhost=2";
            }
            ...
            {
                filter.CataID = Convert.ToInt32(this.ddlparent.SelectedValue);
                            ...
                            <div class="box-content">
                                <div class="head">
                                    <h2>
                                        当前项目</h2>
                                    <div class="search">
                                        属性：<asp:DropDownList ID="ddlhost" runat="server">
                                            <asp:ListItem Value="0">请选择</asp:ListItem>
                                            <asp:ListItem Value="2">推荐</asp:ListItem>
                                            <asp:ListItem Value="1">新品</asp:ListItem>
                                        </asp:DropDownList>
                                        分类：<asp:DropDownList ID="ddlparent" runat="server">
                                        </asp:DropDownList>
                                    ...
                                    <table id="orders-list" cellspacing="0" cellpadding="0" border="0" class="coupons-table">
                                        ...
                                        %>
                                            ...
                                            <td class="op">
                                                ...
                                                <a class="deal-title" href="Project_DangqianXiangmu.aspx?remove=<%= teamInfo.Id%>"
                                                    ask="确定删除本项目吗?">删除</a>｜ <a class="deal-title" href="Project_DangqianXiangmu.aspx?add=<%= teamInfo.Id %>"
                                                        ask="确定复制本项目吗？">复制</a>
                                                <%
