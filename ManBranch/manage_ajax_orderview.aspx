    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        if (order != null)
        {
            ...
            if (order.Team_id == 0)
            {
                ...
                {
                    team_titel = team_titel + "项目ID:" + teams.Id + teams.Title + "</br>";
                }
            ...
            else
            {
                ...
                else if (order.Teams != null && order.Teams.Count>0)
                {
                    ...
                    {
                        team_titel += detail.Teamid + ":";
                        team_titel += detail == null ? "" : detail.Team.Title + "<font style='color:red'>" + AS.Common.Utils.WebUtils.Getbulletin(detail.result) + "</font>";
                        team_titel += "<br>";
                    } 
                }
                else
                {
                    team_titel = "<a>项目已不存在!</a>"; 
                }
            }
