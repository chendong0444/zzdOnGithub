...
<script runat="server">
    ...
    private void InitData()
    {
        ...
        foreach (IOrder order in list_order)
        {
            ...
            sb2.Append("<td class='op'><a class='deal-title' href='Dingdan_DangqiDingdan.aspx?id=" + order.Id + "' ask='确定本单为现金付款?'>现金</a>｜<a class='deal-title' href='Dingdan_WeiFuDingdan.aspx?delete=" + order.Id + "' ask='确定删除本单吗？'>删除</a>｜<a class='ajaxlink' href='ajax_manage.aspx?action=orderview&orderview=" + order.Id + "'>详情</a></td>");
            sb2.Append("</tr>");
        }
