                            ...
                            <div class="box-content">
                                ...
                                <div class="sect">
                                    ...
                                    <div class="field">
                                        ...
                                        <input type="text" group="city" name="display" id="Text5" value="<%=icategory.Display %>"  class="f-input" style="text-transform:uppercase; width:200px"  />
                                    </div>
                                    <div class="field">
                                        <label>排序(降序)</label>
                                    ...
                                    <div class="field">
                                        <label>导航显示(Y/N)</label>
                                        <input type="text" group="city" name="display" id="display"  class="f-input" style="text-transform:uppercase; width:200px"   />
                                    </div>
                                    <div class="field">
                                        <label>排序(降序)</label>
