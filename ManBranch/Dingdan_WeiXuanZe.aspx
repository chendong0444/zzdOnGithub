...
<script type="text/javascript">
    ...
    function GetOrdersId() {
        ...
        if (str.length > 0) {
            ...
            if (istrue) {
                X.get(webroot + "ajax_print.aspx?expressid=" + $("#expresses").val() + "&action=selectexpress&all_id=" + str);
            }
    ...
    function updateorder(orderid) {
        ...
        X.get(webroot + "ajax_manage.aspx?action=updateorder&orderid=" + orderid + "&expressid=" + $("#order_express_id_" + orderid).val());
    }
                                    ...
                                    <table id="orders-list" cellspacing="0" cellpadding="0" border="0" class="coupons-table">
                                        ...
                                        <td> <input type="checkbox" name="check" id="check" value='<%=order.Id %>' /></td>
                                            ...
                                            <td class='xiangmu'>
                                                ...
                                                %>
                                                项目ID:<%= teams.Id%>
                                                (<a class="deal-title" href='<%=getTeamPageUrl(teams.Id) %>' target="_blank"><% =StringUtils.SubString(teams.Title, 70) + "..."%></a>)</br>
                                                <%
                                                    }
}
else
