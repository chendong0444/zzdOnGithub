...
<script runat="server">
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        if (Request["id"] != null)
        {
            ...
            p = Request["p"];
            bulletin = Gettest(0, teammodel, Convert.ToInt32(Request["id"]), 1);
    ...
    public static string Gettest(int num, ITeam model, int teamid, int back)
    {
        ...
        if (Getbulletin(bulletin) != "")
        {
            ...
            if (Getbulletin(teammodel.invent_result) == "")
            {
                ...
                str += "<b>价格：</b><input type=\"text\" value='" + team_price + "' onkeyup=\"checkIsNum(this," + team_price + ")\" size='5' name=\"bmoney" + num + "\"/>&nbsp;&nbsp;";
            ...
            else
            {
                ...
                for (int i = 0; i < bullteam.Length; i++)
                {
                    ...
                    if (back == 1)
                    {
                        str += "<b>价格：</b><input type=\"text\" value='" + money + "' onkeyup=\"checkIsNum(this," + money + ")\" size='5' name=\"bmoney" + num + "\"/>&nbsp;&nbsp;";
                        str += "总库存:" + sum;
                        str += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;增加库存<input id='textfield' num_tid='" + teamid + "' name='insertnum" + num + "' type='text'   value='0' size='5' onkeyup=\"clearNoNum(this)\" />&nbsp;";
                        str += "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;减少库存<input id='textfield' num_tid='" + teamid + "' name='deletenum" + num + "' type='text'   value='0' size='5' onkeyup=\"clearNoNum(this)\" />&nbsp;&nbsp;&nbsp;&nbsp;";
...
<p id="coupon-dialog-display-id1" style="color:Red;"></p>
	...
	<p class="act">	<input type="button" value="提交"  class="formbutton"  name="query"  onclick="X.coupon.invent(<%=Teamid %>,encodeURIComponent(selectInput()),'<%=p %>');return false;"  />
       <% }
          else
          {%>
	...
	<p class="act">	<input type="button" value="提交"  class="formbutton"  name="query"  onclick="X.coupon.invent(<%=Teamid %>,Getinventory(),'<%=p%>');return false;"  />
       <% }%>    
