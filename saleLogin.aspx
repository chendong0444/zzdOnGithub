...
<script runat="server">
    ...
    {
        base.OnLoad(e);
        type = "sale";// Helper.GetString(Request["type"], String.Empty);
        Form.Action = "/saleLogin.aspx?type=" + type;//GetUrl("后台管理", type != String.Empty ? "saleLogin.aspx?type=" + type : "saleLogin.aspx");
...
<div id="login_bd">
	<div class="login_bd">
      <div class="login_hd">
        ...
        <div class="lgtit_mid">
        	<ul id="css">
            <li class="lg_lf <%if(type=="sale" || type==""){%>now_select<%} %> "><a href="<%=GetUrl("后台管理","Login.aspx?type=sale")%>">销售后台</a></li>
