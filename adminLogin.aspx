...
<script runat="server">
    ...
    {
        base.OnLoad(e);
        type = "admin";// Helper.GetString(Request["type"], String.Empty);
        Form.Action = "/adminLogin.aspx?type=" + type;//GetUrl("后台管理", type != String.Empty ? "adminLogin.aspx?type=" + type : "adminLogin.aspx");
...
<div id="login_bd">
	<div class="login_bd">
      <div class="login_hd">
        ...
        <div class="lgtit_mid">
        	<ul id="css">
            <li class="lg_lf <%if(type=="admin" || type==""){%>now_select<%} %> "><a href="<%=GetUrl("后台管理","Login.aspx?type=admin")%>">管理后台</a></li>
