...
<div id="go_lstop" class="uptop">
    <a onclick="window.scrollTo(0,0);">
        <img src="<%=ImagePath() %>backtotop.gif"></a>
</div>
        ...
        <ul class="cf">
            <li class="col">
                ...
                <ul class="sub-list">
                    ...
                    <li><a href="<%=GetUrl("东购团概念","help_asdht.aspx")%>">
                        <%=abbreviation%>概念</a></li>
            ...
            <li class="col">
                ...
                <ul class="sub-list">
                    <%if (CurrentCity != null)
                      { %>
                    <li><a href="<%=GetUrl("邮件订阅","help_Email_Subscribe.aspx?cityid="+CurrentCity.Id)%>">
                        邮件订阅</a></li>
                    <li><a href="<%=GetUrl("RSS订阅","help_RSS_feed.aspx?ename="+CurrentCity.Ename)%>">RSS订阅</a></li>
                    <li><a href="<%=GetUrl("意见反馈","feedback_suggest.aspx")%>">意见反馈</a></li>
                    <%} %>
                    <%else
                      { %>
