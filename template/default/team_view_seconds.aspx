...
<%@ Register Src="~/UserControls/blockothersseconds.ascx" TagName="blockothersseconds"
    TagPrefix="uc6" %>
<script runat="server">
    string detail = "";
    ...
    protected string buyUrl = String.Empty; //购买链接l 
    ...
    protected override void OnLoad(EventArgs e)
    {
        ...
        nonetimefix = Helper.GetTimeFix(CurrentTeam.Begin_time) * 1000;
        nonetimefix = nonetimefix - curtimefix;
        ...
        else if (state == AS.Enum.TeamState.none)
        {
            teamstatestring = "none";
        }
        ...
        if (CurrentTeam.Begin_time > DateTime.Now)
            ...
            buyUrl = GetUrl("优惠卷购买", "team_buy.aspx?id=" + CurrentTeam.Id);
            ...
            <div class="sysmsg-tip-content">
                <div class="deal-close">
                    ...
                    <div id="tip-deal-subscribe-body" class="body">
                        <table>
                            <tr>
                                <td>不想错过明天的秒杀？立刻订阅每日最新秒杀信息：&nbsp;
                                </td>
                                <td>
                                    <input type="text" name="sub_email" id="sub_email" class="f-text" value="" require="true"
                                        datatype="email" />
                                </td>
                                <td>&nbsp;<input id="Button3" type="button" class="commit validator" value="订阅" onclick="checksub_email()" />
                                </td>
                            </tr>
                        </table>
                    </div>
        ...
        <div id="deal-default">
            ...
            <div id="deal-default">
                ...
                <div id="sidebar">
                    ...
                    <uc6:blockothersseconds ID="blockothersseconds1" Visible="true" runat="server" />
                    <%LoadUserControl(PageValue.WebRoot + "UserControls/blockask.ascx", CurrentTeam); %>
                ...
                <div id="content">
                    <div id="deal-intro" class="cf">
                        ...
                        <div class="main">
                            <div class="deal-buy">
                                ...
                                <p class="deal-price">
                                    ...
                                    <%if (!isCreditseconds)
                                      {
                                          ...
                                          {
                                    %>
                                    <a href="<%=buyUrl %>"><span class="deal-price-miaosha"></span></a>
                                    <%
                                    ...
                                    <%}
                                              ...
                                              {%>
                                    <a href="<%=buyUrl %>"><span class="deal-price-creditmiaosha"></span></a>
                                    <% }
                                          }
                                      }
                                      else
                            ...
                            <%if (state == AS.Enum.TeamState.none)
                              { %>
                            <div class="deal-box deal-timeleft deal-ms_start" id="deal-timeleft" curtime="<%=curtimefix %>"
                                diff="<%=nonetimefix %>">
                                <div class="limitdate">
                                    <ul id="counter">
                                        <%if ((CurrentTeam.Begin_time - DateTime.Now).Days > 0)
                                          { %>
                                        <span>
                                            <%=(CurrentTeam.Begin_time-DateTime.Now).Days %></span>天<span><%=(CurrentTeam.Begin_time-DateTime.Now).Hours %></span>时<span><%=(CurrentTeam.Begin_time-DateTime.Now).Minutes %></span>分<span><%=(CurrentTeam.Begin_time - DateTime.Now).Seconds%></span>秒
                                        <%}
                                          else
                                          { %>
                                        <span>
                                            <%=(CurrentTeam.Begin_time-DateTime.Now).Hours %></span>时<span>
                                                <%=(CurrentTeam.Begin_time-DateTime.Now).Minutes %></span>分<span>
                                                    <%=(CurrentTeam.Begin_time-DateTime.Now).Seconds %></span>秒
                                        <%} %>
                                    </ul>
                                </div>
                            </div>
                            <%}
                              ...
                              { %>
                            <%if (state == AS.Enum.TeamState.fail || state == AS.Enum.TeamState.successnobuy || state == AS.Enum.TeamState.successtimeover)
                              { %>
                            <%if (CurrentTeam.Close_time.HasValue)
                              { %>
                            <div class="deal-box deal-timeleft deal-miaosha_end" id="Div3" curtime="<%=curtimefix %>"
                                diff="<%=difftimefix %>">
                                <div class="limitdate">
                                    <p class="deal-buy-ended">
                                        <%=overtime.ToString("yyyy-MM-dd ")%><br />
                                        <%=overtime.ToString("HH:mm:ss")%>
                                    </p>
                                </div>
                            </div>
                            <%} %>
                            <%}
                              ...
                              { %>
                            <div class="deal-box deal-timeleft bg-ms-end" id="Div4" curtime="<%=curtimefix %>"
                                diff="<%=difftimefix %>">
                                <div class="limitdate">
                                    <ul id="Ul1">
                                        <%if ((CurrentTeam.End_time - DateTime.Now).Days > 0)
                                          { %>
                                        <span>
                                            <%=(CurrentTeam.End_time-DateTime.Now).Days %></span>天<span><%=(CurrentTeam.End_time-DateTime.Now).Hours %></span>时<span><%=(CurrentTeam.End_time-DateTime.Now).Minutes %></span>分
                                        <%}
                                          else
                                          { %>
                            ...
                            <div class="deal-box deal-status" id="deal-status">
                                <%if (CurrentTeam.Max_number - CurrentTeam.Now_number > 0)
                                  { %>
                                <p class="deal-buy-tip-top">
                                    还剩 <strong>
                                        <%=(CurrentTeam.Max_number - CurrentTeam.Now_number)%></strong>
                                </p>
                                <%}
                                  else if (CurrentTeam.Max_number == 0 && CurrentTeam .inventory>0)
                                  { %>
                                <p class="deal-buy-tip-top">
                                    秒杀进行中
                                </p>
                                ...
                                <div class="cf">
                                    ...
                                    <div class="max">
                                        <%=CurrentTeam.Min_number%>
                                    </div>
                                </div>
                                <p class="deal-buy-tip-btm">
                                    还差 <strong>
                                        <%=(CurrentTeam.Min_number - CurrentTeam.Now_number)%></strong> 人到达最低秒杀人数
                                </p>
                            </div>
                            <%}
                              else if (state != AS.Enum.TeamState.none)
                              { %>
                            <div class="deal-box deal-status deal-status-open" id="Div5">
                                <p class="deal-buy-tip-top">
                                    <strong>
                                ...
                                <p class="deal-buy-on" style="line-height: 200%;">
                                    ...
                                    秒杀成功
                                    <%if (state == AS.Enum.TeamState.successbuy)
                                      { %>
                                    可以继续秒杀<%} %>
                                </p>
                            </div>
                            ...
                            <%}
                              ...
                              { %>
                            <div class="deal-box deal-status deal-status-<%=teamstatestring%> %>" id="Div6">
                                <div class="deal-buy-seconds">
                                </div>
                                <p class="deal-buy-tip-total">
                                    共有 <strong>
                                        <%=CurrentTeam.Now_number %></strong> 人购买
                                </p>
                            </div>
                            <%} %>
                        </div>
                            ...
                            <div class="box-content cf">
                                <div class="main" id="team_main_side">
                                    ...
                                    <div class="buttonbuy">
                                        ...
                                        <a href="#"><span class="deal-price-buy"></span></a>
                                    </div>
                                                            ...
                                                            <div class="comments">
                                                                <div class="deal_pic">
                                                                    <a href="<%=getTeamPageUrl(Helper.GetInt(ur.review_teamid,0))%>" target="_blank">
                                                                        <img <%=ashelper.getimgsrc(ur.Image) %> class="dynload" width="110" height="70" border="0" />
                                                                    </a>
                                                                </div>
